    ...
    <>
        <div className="py-5">
            <motion.h1
                ...
                className="font-bold text-5xl text-center leading-tight pt-12 opacity-0"
            >
                Hi! I&apos;m Sam, <br></br>
            </motion.h1>
            <motion.h1
        ...
        <div className="py-4 flex justify-center space-x-3">
            <a href="https://github.com/samuelthaiyil" target="_blank" className="text-2xl bg-zinc-700 text-white py-4 px-5 rounded hover:bg-zinc-600 hover:duration-300">
