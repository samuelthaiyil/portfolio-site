...
export const Hero = () => (
    <>
        ...
        <div className="py-4 flex justify-center space-x-3">
            ...
            <Link href="/contact" className="text-2xl bg-blue-600 dark:bg-blue-500 text-white py-4 px-5 rounded hover:bg-blue-500 dark:hover:bg-blue-400 transition hover:duration-300 group">
