export const About = () => (
    <>
        <h2 className="font-bold text-5xl text-center pt-24 pb-0">
            About me
        </h2>
        <ul className="text-lg space-y-12 p-12 leading-loose text-slate-500">
            <li>
                My passion for computer science ignited when I was introduced to coding at an early age, transforming a casual
